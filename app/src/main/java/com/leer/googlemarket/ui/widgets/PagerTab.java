...
import com.leer.googlemarket.ui.acitvities.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private int mTabTextColorResId = R.color.selector_tab_text; //tab文字颜色
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setTextColor(UIUtils.getColorStateListRes(mTabTextColorResId));
		tab.setBackgroundDrawable(UIUtils.getDrawableRes(mTabBackgroundResId));
